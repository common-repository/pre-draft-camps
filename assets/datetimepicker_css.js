...
var StartYear = 1980; //First selectable year
var EndYear = 30; // The offset last year of pickable date. If current year is 2011, the last year that still picker will be 2016 (2011+5)
...
var imageFilesPath = ""; //Path of date time picker image files relative to HTML page.
...
function RenderCssCal(bNewCal)
{
	...
	else //if not to show time.
	{
	    ...
	    //close button
	    if (UseImageFiles) {
	        vCalClosing += "<img onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();' src='"+imageFilesPath+"cal_close.gif' width='12px' height='12px' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>";
	    }
	    else {
